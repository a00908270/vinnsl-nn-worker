...
public class NNTest {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Vinnsl vinnslObject = restTemplate.getForObject("http://127.0.0.1:8080/vinnsl/5aa31ef356645d36f1999a8b", Vinnsl.class);
		
		restTemplate.put("http://127.0.0.1:8080/status/5aa31ef356645d36f1999a8b/INPROGRESS", null);
		...
		restTemplate.put("http://127.0.0.1:8080/dl4j/5aa31ef356645d36f1999a8b", configuration.toJson());
...
/*		NeuralNetConfiguration.Builder conf = new NeuralNetConfiguration.Builder();
		...
		*/
		...
		restTemplate.put("http://127.0.0.1:8080/status/5aa31ef356645d36f1999a8b/FINISHED", null);
