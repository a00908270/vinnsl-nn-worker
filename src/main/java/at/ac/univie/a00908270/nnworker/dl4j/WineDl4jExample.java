...
public class WineDl4jExample {
	
	
	private static Logger log = LoggerFactory.getLogger(WineDl4jExample.class);
	...
	public static void main(String[] args) throws Exception {
		...
		recordReader.initialize(new FileSplit(new ClassPathResource("winemag-data-SET_2-TRAIN.csv").getFile()));
		...
		int batchSize = 20000;    //Iris data set: 150 examples total. We are loading all of them into one DataSet (not recommended for large data sets)
